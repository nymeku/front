...
//           : item.photos[0]
//         : ""
//         }" alt="" style="width:300px;height:200px;"/><div style="display:grid;grid-template-columns: auto 1fr;grid-auto-rows: 1fr; padding: 16px 20px;column-gap: 20px;"><span style="color: darkgray;font-size:0.8rem">Nom</span><span style="white-space: nowrap;overflow: hidden;text-overflow: ellipsis;">${item.name
...
//           item.types[0]
//         )}</span><span style="color: darkgray;font-size:0.8rem">Adresse</span> <span style="white-space: nowrap;overflow: hidden;text-overflow: ellipsis;">${item.address
//         }</span></div></div>`;
//     })
//     .join("<br/>");
//   const page = `<html><head><style>*{font-family: "Nunito Sans", sans-serif;}</style><title>Votre provhain voyage</title></head><body><h1>Votre prochain voyage</h1><div>Destination: ${config.destination
...
//     }">Voir en ligne</a><br/> ou utiliser ce lien : ${window.location.href
    ...
    <>
      <div className="trip">
        ...
        <button
          ...
          onClick={() => window.open(API_URL + '/print/' + id)}
        >
