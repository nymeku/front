  ...
  return (
    <main className="home">
      <header>
        ...
        <img
          className="logo"
          src="https://timenjoy.fr/img/logo-dark.svg"
          alt=""
        />
        <nav>
      ...
      <section className="hero">
        ...
        <div className="foreground">
          ...
          <h3>
            Planifiez votre prochain voyage et profitez pleinement de votre
            destination
          </h3>
        </div>
        <Searchbar
      ...
      <section className="sect-2 left">
        <div className="text">
          ...
          <p>
            Suspendisse ac tristique sapien. Vestibulum nisi orci, finibus in
            massa vel, porta imperdiet dolor. Duis sit amet orci eget arcu
            ultrices egestas pretium nec massa. Interdum et malesuada fames ac
            ante ipsum primis in faucibus. Sed nec lectus massa. Quisque arcu
            quam, porta vel tincidunt et, volutpat ut massa.
          </p>
      ...
      <section className="sect-2 right">
        ...
        <div className="text">
          <h2>
            Enivrez-vous des cultures lointaines et découvrez une part de
            vous-même.
          </h2>
          <p>
            Nunc dapibus nunc lorem, sed rhoncus massa tincidunt eget. Integer
            ullamcorper felis at odio mattis, id mattis dolor vulputate. Duis
            sed est eget tellus ultricies finibus luctus id tellus. Phasellus
            urna enim, luctus nec felis in, pulvinar eleifend eros. Duis rhoncus
            risus vel turpis mollis, non lobortis ipsum aliquam.
          </p>
      ...
      <section className="sect-2 left">
        <div className="text">
          ...
          <p>
            Fusce hendrerit, nibh quis aliquet sollicitudin, arcu elit pretium
            magna, in varius metus libero nec magna. Suspendisse non ante a mi
            bibendum ornare a non augue.
          </p>
      ...
      <section
        className="sect-3"
        style={{ backgroundImage: 'url("/img/boat.jpg")' }}
      >
      ...
      <section className="sect-4">
        <h2>
          Laissez-vous guider pas-à-pas dans l'organisation de vos vacances.
        </h2>
        <h4>
          Fusce hendrerit, nibh quis aliquet sollicitudin, arcu elit pretium
          magna, in varius metus libero nec magna. Suspendisse non ante a mi
