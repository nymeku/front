        ...
        <main className="home">
            ...
            <section className="sect-2 left">
                <div className="text">
                    ...
                    <p>
                        Suspendisse ac tristique sapien. Vestibulum nisi orci, finibus in massa vel, porta imperdiet dolor. Duis sit amet orci eget arcu ultrices egestas pretium nec massa. Interdum et
                        malesuada fames ac ante ipsum primis in faucibus. Sed nec lectus massa. Quisque arcu quam, porta vel tincidunt et, volutpat ut massa.
                    </p>
            ...
            <section className="sect-2 right">
                ...
                <div className="text">
                    ...
                    <p>
                        Nunc dapibus nunc lorem, sed rhoncus massa tincidunt eget. Integer ullamcorper felis at odio mattis, id mattis dolor vulputate. Duis sed est eget tellus ultricies finibus
                        luctus id tellus. Phasellus urna enim, luctus nec felis in, pulvinar eleifend eros. Duis rhoncus risus vel turpis mollis, non lobortis ipsum aliquam.
                    </p>
            ...
            <section className="sect-2 left">
                <div className="text">
                    ...
                    <p>Fusce hendrerit, nibh quis aliquet sollicitudin, arcu elit pretium magna, in varius metus libero nec magna. Suspendisse non ante a mi bibendum ornare a non augue.</p>
            ...
            <section className="sect-4">
                ...
                <h4>Fusce hendrerit, nibh quis aliquet sollicitudin, arcu elit pretium magna, in varius metus libero nec magna. Suspendisse non ante a mi bibendum ornare a non augue.</h4>
